<template>
    <div class="flex flex-col w-full bg-white pt-20 pb-32 px-16 gap-16 items-center justify-center">
        <div class="flex flex-col gap-16 w-1/2 items-center">
            <div class="flex justify-center w-full">
                <img src="@/assets/svg/team.svg" class="w-1/2">
            </div>
            
            <div class="flex flex-col gap-3 items-center text-center">
                <p class="font-semibold tracking-wide text-amber-400">TEAM KAMI</p>
                <h1 class="text-4xl font-bold tracking-tight text-darkTeal">Kami membawa berbagai skill dan pengalaman dari berbagai latar belakang.</h1>
                <p class="text-gray-400">Kami memiliki filosofi yang sederhana; Merekrut tenaga berbakat dan memberikan mereka resource yang dibutuhkan untuk membangun Luminds menjadi lebih baik lagi.</p>
            </div>
        </div>
    </div>    
    
    <div class="flex flex-col w-full bg-white pb-32 px-32 gap-16">
        <div class="flex flex-col gap-10">
            <h1 class="text-4xl font-bold tracking-tight text-darkTeal">
                Manajer dan Staff
            </h1>
                    ...
                    <div>
                        ...
                        <div class="flex pt-5 gap-2">
                            ...
                            <p class="text-sm py-3 italic self-center text-center">
                                Jika mencari cara mudah, kita pasti dikhianati oleh hasil. Tapi jika melakukan dengan benar kita pasti akan mendapatkan manfaatnya.
                            </p>
                ...
                <div class="flex flex-col w-1/4 gap-4">
                    ...
                    <div>
                        ...
                        <div class="flex pt-5 gap-2">
                            ...
                            <p class="text-sm py-3 italic self-center text-center">
                                Life works in mysterious ways, it's our duty to unravel it.
                            </p>
                ...
                <div class="flex flex-col w-1/4 gap-4">
                    ...
                    <div>
                        ...
                        <div class="flex pt-5 gap-2">
                            ...
                            <p class="text-sm py-3 italic self-center text-center">
                                To underestimate oneself is to overlook your potential of greatness.
                            </p>
                ...
                <div class="flex flex-col w-1/4 gap-4">
                    ...
                    <div>
                        ...
                        <div class="flex pt-5 gap-2">
                            ...
                            <p class="text-sm py-3 italic self-center text-center">
                                The best way to make your dreams come true is to wake up and make it real.
                            </p>
